...
void init_other_types(py::module_ &wf) {
    ...
    py::class_<PyWFFileVIOTask, PySubTask>(wf, "FileVIOTask")
        ...
        .def("get_args",      &PyWFFileVIOTask::get_args)
    ...
    py::class_<PyWFFileSyncTask, PySubTask>(wf, "FileSyncTask")
        ...
        .def("get_args",      &PyWFFileSyncTask::get_args)
    ...
    py::class_<PyFileIOArgs, PyWFBase>(wf, "FileIOArgs")
        .def("is_null",       &PyFileIOArgs::is_null)
        .def("get_fd",        &PyFileIOArgs::get_fd)
        .def("get_content",   &PyFileIOArgs::get_content)
        .def("get_offset",    &PyFileIOArgs::get_offset)
        .def("get_count",     &PyFileIOArgs::get_count)
    ;
    py::class_<PyFileVIOArgs, PyWFBase>(wf, "FileVIOArgs")
        .def("is_null",       &PyFileVIOArgs::is_null)
        .def("get_fd",        &PyFileVIOArgs::get_fd)
        .def("get_content",   &PyFileVIOArgs::get_content)
        .def("get_offset",    &PyFileVIOArgs::get_offset)
    ;
    py::class_<PyFileSyncArgs, PyWFBase>(wf, "FileSyncArgs")
        .def("is_null",       &PyFileSyncArgs::is_null)
        .def("get_fd",        &PyFileSyncArgs::get_fd)
    ;
